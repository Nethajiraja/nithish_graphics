      ...
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-600">
            Sign in with your registered mobile number to access your dashboard and track orders.
          </p>
        </div>
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/80 shadow-xl space-y-5">
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <a
              ...
              className="w-full border border-slate-300 bg-white hover:bg-slate-50 text-slate-700 font-bold py-3 rounded-xl shadow-xs transition-all text-xs flex items-center justify-center space-x-2.5 cursor-pointer"
            >
