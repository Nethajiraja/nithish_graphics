...
export const LoginPage: React.FC<LoginPageProps> = ({ info, onLoginSuccess, navigate, redirectPath, noticeMessage }) => {
  ...
  // Parse error message from URL query params if present
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/80 shadow-xl space-y-5">
          ...
          <div>
            <a
              ...
              className="w-full bg-white hover:bg-slate-50 text-slate-700 font-bold py-3.5 px-4 rounded-xl border border-slate-300 shadow-xs transition-all text-xs flex items-center justify-center space-x-3 cursor-pointer group"
            >
          ...
          <div className="relative my-2">
            ...
            <div className="relative flex justify-center text-[11px] uppercase">
              <span className="bg-white px-3 font-extrabold text-slate-400">OR</span>
            </div>
          </div>
